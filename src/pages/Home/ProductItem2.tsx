  ...
  return (
    <div className="h-fit max-w-72 min-w-36 flex-1 items-center border border-[#282c3f0d] p-3">
      <div className="flex flex-col gap-5">
        <div className="relative flex h-30 justify-center rounded-lg">
          ...
          <img
            src={item.product_variants[defaultVariantIndex].image[0]}
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="h-[1px] w-full bg-[#02060c0d]"></div>
