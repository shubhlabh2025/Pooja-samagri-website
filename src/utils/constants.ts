export const AboutUsText = `
  ...
  <p style="color: #d97300; font-weight: bold; font-size: 1.2rem;">Namaste!</p>

  <p>
    Welcome to the world of <strong>SHUBH LABH Pooja Samagri, Bringing Devotion To Your Doorstep..</strong>
  </p>
<br/>
  <p>
...
<br/>
  ...
  <p>
    With Began as a thoughtful business initiative has since flourished into a growing enterprise, with the goal of becoming a leading brand in India’s devotional space. The company specializes in delivering an unlimited range of Pooja Products through our website, Android & iOS platforms.
  </p>
<br/>

  <p>
    Bringing devotion directly to the doorsteps of households across the nation.
  </p>
<br/>

  <p>
    Currently, the operations are handled by Yesh Bandaru, keeping it all in house to maintain the piousness and purity of the products, and maintaining safe deliveries. With hundreds of satisfied customers every month they only get encouraged.
  </p>
<br/>

  <p style="font-weight: bold; font-size: 1.3rem;">
    To Touch more hearts and inspire<br />
    a deeper connection to spiritual<br />
    Tradition.
  </p>
<br/>

  <p style="font-weight: bold; font-size: 1.1rem;">Our Vision…</p>

  <p style=" font-style: italic;">
    “ Is to provide the finest religios products,<br />
    upholding purity, heartfelt devotion and<br />
    uncompromising hygiene in every offering.”
  </p>
<br/>

  <b>SHUBH LABH POOJA SAMAGRI</b>, your one stop solution for all your Religious goods, Festive and Marriage Function needs. We specialize in providing a wide range of items that are essential for religious ceremonies, rituals and traditional wedding celebrations. At our store, we take pride in offering High-Quality Products that cater to your spiritual and cultural requirements.<br/><br/>

  <b>Religious Items:</b><br/>
  We understand the significance of religious practices in your life. That’s why we offer a diverse selection of religious items...<br/><br/>

  <b>Personalized Services:</b><br/>
  At SHUBH LABH POOJA SAMAGRI, we strive to offer personalized services...<br/><br/>

  <b>Quality Assurance:</b><br/>
  We understand the importance of authenticity and quality...<br/><br/>

  <b>Convenience and Accessibility:</b><br/>
